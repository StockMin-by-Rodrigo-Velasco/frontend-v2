...
export default function ListaProductosRegistrarAlmacenWindow({ closeButton, productos, setProductos, arrayData, replaceData }: ListaProductosOutAlmacenProp) {
    ...
    const pushProductos = () => {
        ...
        const arrayDataObj = arrayData.reduce((acc, producto) => 
            { acc[producto.productoId] = producto; return acc; }, {} as Record<string, FormTable>);
        ...
        const selectedProductos: FormTable[] = productos
            ...
            .map(p => ({ 
                ...
                cantidadMinima: arrayDataObj[p.productoId]?.cantidadMinima || 0
            }));
